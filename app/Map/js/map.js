...
var SERVER_SECRET = '12345';	// must match config.php not super secure, but prevents bots.
...
function getMarkerList() {
	...
	$.ajax({
		 ...
		 success:  function(data) {
			...
			var tmpMarkers = [];
			tmpMarkers =  jQuery.parseJSON(markerString);
...
function createMarker( info,  index) {
	...
	var content = "<h3>Informa&ccedil;&otilde;es </h3>Nome do Usu&aacuterio:"+ info.nome +"<br/><div id='latlng'>Atualizado em: "+ info.data +" <br /> Lat: "+ info.lat + "<br> Lng: "+ info.lng + "</div>"; //<div id='foto'><img width='50' height='50' src='"+ info.foto +"' /></div>
